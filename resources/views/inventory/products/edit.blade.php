    ...
    <div class="container">
        ...
        <div class="mb-6">
            ...
            <h1 class="page-title font-bold text-gray-800">
                ...
                <span class="product-name-highlight">{{ $product->name }}</span>
            </h1>
        </div>

        <div class="mobile-card">
            <form action="{{ route('inventory.products.update', $product) }}" method="POST" id="editProductForm">
                @csrf
                @method('PUT')
                ...
                <button type="submit" class="submit-btn" id="submitBtn">
                    ...
                    <span id="submitText">{{ $isFrench ? 'Mettre à jour le Produit' : 'Update Product' }}</span>
                </button>
            </form>
        </div>
    </div>
