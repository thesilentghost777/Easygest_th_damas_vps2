...
@section('content')
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ $isFrench ? 'Réclamer ma Ration' : 'Claim my Ration' }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 mb-6">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-yellow-700">
                                    {{ $isFrench ? 
                                        ...
                                        "You are not marked as present today. You cannot claim your ration."
                                    }}
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-green-700">
                                    {{ $isFrench ? 
                                        ...
                                        "You have already claimed your ration for today."
                                    }}
                                </p>
                            </div>
                        </div>
                ...
                <div class="mt-10">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">
                        {{ $isFrench ? 'Historique de mes rations' : 'My ration history' }}
                    </h3>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        {{ $isFrench ? 'Heure de réclamation' : 'Claim time' }}
                                    </th>
                                </tr>
                            </thead>
