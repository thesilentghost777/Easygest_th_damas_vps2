            ...
            <div class="animate-fade-in">
                ...
                <ul class="space-y-1 lg:space-y-2">
                  @if (auth()->user()->role == 'gestionnaire_alimentation')
                    <li>
                        <a href="{{ route('employees.index') }}" class="flex items-center p-2 rounded hover:bg-white/10">
                            <i class="mdi mdi-chart-box-outline mr-2"></i>
                            {{ $isFrench ? 'Évaluation des employés' : 'Employee evaluation' }}
                        </a>
                    </li>
                ...
                <li>
                    <a href="{{ route('inventory.groups.index') }}" class="flex items-center p-2 rounded hover:bg-white/10">
                        <i class="mdi mdi-package-variant mr-2"></i>
                        {{ $isFrench ? 'Calcul des manquants' : 'Shortage calculator' }}
                    </a>
                </li>
