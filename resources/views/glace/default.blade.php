...
<div class="flex min-h-screen" x-data="{ sidebarOpen: false }">
    ...
    <aside
        ...
        <div class="text-center border-b border-white/20 pb-6">
            ...
            <span class="text-xs">Powered by TFS237</span>
        </div>
        ...
        <div class="mt-6 space-y-8 overflow-y-auto">
            ...
            <div>
               ...
               <ul class="space-y-2">
               <li><a href="{{ route('producteur.workspace') }}" class="flex items-center p-2 rounded hover:bg-white/10"><i class="mdi mdi-food mr-2"></i>Produits du jour</a></li>
               ...
               <i class="mdi mdi-package-variant mr-2"></i>Réservation MP
               </a>
               </li>
               @endfeature
               <li class="flex items-center p-2 rounded hover:bg-white/10 cursor-pointer">
               <a href="{{ route('assignations.mes-assignations') }}">
               <i class="mdi mdi-clipboard-check mr-2"></i>Matières Assignées
               </a>
               </li>
               <li class="flex items-center p-2 rounded hover:bg-white/10 cursor-pointer">
            ...
            <li>
                <a href="#" class="flex items-center p-2 rounded-lg hover:bg-white/10 transition-colors group">
                   <i class="mdi mdi-package-variant-closed-check mr-3 text-blue-200 group-hover:text-white"></i>
