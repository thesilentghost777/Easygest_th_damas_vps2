            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-green-600 px-6 lg:px-8 py-6">
                    ...
                    <p class="text-blue-50 mt-2">
                        {{ $isFrench ? "Veuillez remplir les informations ci-dessous" : "Please fill in the information below" }}
                    </p>
                </div>

                <!-- Form -->
                <form action="{{ route('extras.store') }}" method="POST" class="p-6 lg:p-8 space-y-6 lg:space-y-8">
                    @csrf
                        ...
                        <div class="relative">
                            <select
                                ...
                                <option value="alimentation" {{ old('secteur', $extra->secteur ?? '') == 'alimentation' ? 'selected' : '' }}>
                                    {{ $isFrench ? "Alimentation" : "General store" }}
                                </option>
                    ...
                    <div class="flex flex-col lg:flex-row gap-4 pt-6">
                        <button type="submit"
                            ...
                            {{ $isFrench ? "Créer la réglementation" : "Create Regulation" }}
                        </button>
