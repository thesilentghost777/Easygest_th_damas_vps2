...
<body class="bg-gray-100 font-sans">
    <div class="flex h-full" x-data="{ sidebarOpen: false }" x-cloak>
        ...
        <button
            ...
            aria-label="{{ $isFrench ? 'Basculer le menu' : 'Toggle menu' }}">
            ...
            <nav class="sidebar-scroll">
                <div class="p-6">
                    ...
                    <div class="menu-section">
                        <a href="{{ route('pdg.workspace') }}" class="menu-link flex items-center px-4 py-3 text-base rounded-lg hover:bg-white/10 transition-colors bg-white/5 mb-4">
        ...
        <span>{{ $isFrench ? 'Cahier de madame willy' : 'willy\'s Ledger' }}</span>
                    ...
                    <div class="menu-section">
                        ...
                        <ul class="space-y-1">  
                            ...
                            <li>
                                <a href="{{ route('statistiques.argent') }}" class="menu-link flex items-center px-4 py-2.5 text-base rounded-lg hover:bg-white/10 transition-colors">
                                    <i class="menu-icon mdi mdi-currency-usd mr-3 text-lg"></i>
                     ...
                     <div class="menu-section">
                        ...
                        <ul class="space-y-1">
                            ...
                            <li>
                                <a href="{{ route('sherlock.conseiller') }}" class="menu-link flex items-center px-4 py-2.5 text-base rounded-lg hover:bg-white/10 transition-colors">
                    ...
                    <div class="menu-section">
                        ...
                        <ul class="space-y-1">
                            ...
                            <li>
                                <a href="{{ route('lecture_message') }}" class="menu-link flex items-center px-4 py-2.5 text-base rounded-lg hover:bg-white/10 transition-colors">
                            ...
                            <li>
                                <a href="{{ route('rapports.select') }}" class="menu-link flex items-center px-4 py-2.5 text-base rounded-lg hover:bg-white/10 transition-colors">
                                    <i class="menu-icon mdi mdi-file-chart-outline mr-3 text-lg"></i>
                    ...
                    <!-- Administration Stratégique Section (utilisée occasionnellement) -->
                    <div class="menu-section">
                        <h3 class="text-base font-semibold uppercase tracking-wider text-white/70 flex items-center px-2 mb-2">
                            <i class="mdi mdi-domain mr-2 text-sm"></i>{{ $isFrench ? 'Administration' : 'Administration' }}
                        </h3>
                        <ul class="space-y-1">
                            <li>
                            ...
                            <li>
                                <a href="{{ route('query.index') }}" class="menu-link flex items-center px-4 py-2.5 text-base rounded-lg hover:bg-white/10 transition-colors">
                                    ...
                                    <span>{{ $isFrench ? 'Informations système' : 'System Information' }}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
