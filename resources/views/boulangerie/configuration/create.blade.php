...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-2">Nouvelle Configuration de Sac</h1>
        <p class="text-gray-600">Définissez les matières utilisées et la valeur moyenne attendue pour ce type de sac.</p>
    </div>

    <div class="bg-white rounded-lg shadow-lg p-6">
        <form action="{{ route('boulangerie.configuration.store') }}" method="POST" id="configForm">
            @csrf
