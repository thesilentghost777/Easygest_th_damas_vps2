...
class Matiere extends Model
{
    ...
    {
        return $this->quantite < $this->quantite_seuil;
    }
    
    /**
     * Détermine si une notification doit être envoyée pour cette matière
     */
    public function shouldNotify(): bool
    {
        return $this->notification_active && $this->isUnderThreshold();
    }
    ...
    {
        return $this->hasMany(Utilisation::class, 'matierep');
    }
}
