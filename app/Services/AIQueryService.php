...
class AIQueryService
{
    ...
    private function buildSystemPrompt(string $schema): string
    {
        return "Tu es un assistant spécialisé en bases de données MySQL. " .
               ...
               "a chaque fois que tu auras a faire au calcul de la production , quantite , benefice , cout des matieres ,  utilise la logique suivante: la table utilisation contient une entrer par matiere utiliser pour une meme production: par exemple si je produit 100 pains aveec 4 matieres premiere , il y'aura 4 matieres entrer dans la table utilisation avec le meme id_lot et avec les meme quantite de produit a 100 : si tu additione juste tu vas addioner 4x100 = 400 or c'est faux vu que c'est une meme prodduction\n" .
               ...
               "Evite d'utiliser les mot de substitution comme Utilisation AS x et si tu veux en utiliser les mots de subtitution doivent etre tres explicite comme utilisation AS util .. pour eviter les erreurs dans les requetes car tu fais trop d'erreur avec cela :: voici un exemple d'erreur a eviter Erreur !SQLSTATE[42S22]: Column not found: 1054 Unknown column 'u.quantite_produit' in 'field list' (Connection: mysql, SQL: SELECT u.name AS producteur, SUM(DISTINCT u.quantite_produit) AS total_produit, u.avance_salaire FROM Utilisation AS x JOIN users AS u ON x.producteur = u.id GROUP BY x.producteur, u.name, u.avance_salaire ORDER BY total_produit DESC LIMIT 1) \n" .
               "Tu peux utiliser les champ created_at pour les courbes et certaines structure ou tu en as besoin\n" .
...
'transaction_ventes' => [
    'id' => 'id',
    'produit' => 'foreignId:Produit_fixes:code_produit',
    'serveur' => 'foreignId:users',
    'quantite' => 'integer',
    'prix' => 'integer',
    'date_vente' => 'date',
    'type' => 'string',
...
'Matiere' => [
    'id' => 'id',
    'nom' => 'string',
    'unite_minimale' => 'string',
    'unite_classique' => 'string',
    'quantite_par_unite' => 'decimal:10,3',
    'quantite' => 'decimal:10,2',
    'prix_unitaire' => 'decimal:10,2',
    'prix_par_unite_minimale' => 'decimal:10,4',
    'created_at' => 'timestamp',
    'updated_at' => 'timestamp',
]
