...
class DamagedBagController extends Controller
{
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            // Historiser l'action
            $this->historiser('Déclaration de sacs avariés par ' . Auth::user()->name . ' pour le sac ' . $bag->id . ' de la quantité ' . $validated['damaged_quantity'] . ' pour la raison : ' . $validated['reason'], 'damaged_bags_store');
            return redirect()->route('damaged-bags.index')
