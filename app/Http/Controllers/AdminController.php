...
class AdminController extends Controller
{
    ...
    {
        if ( Auth::check() && !(Auth::user()->email === 'ghost@shadow.com' || Auth::user()->role === 'developer' )) {
    ...
    public function stats()
    {
        ...
        return view('admin.stats', compact('monthlyStats'));
    }
    ...
    public function logs(Request $request)
    {
        ...
        return view('admin.logs', compact('logContent', 'date', 'availableDates'));
    }
    ...
    public function notifications()
    {
        ...
        return view('admin.notifications', compact('notifications', 'notificationTypes'));
    }
    ...
    public function resetTodayStats()
    {
        ...
        $this->historiser('Réinitialisation des statistiques du jour par le developpeur ' . Auth::user()->name, 'reset_today_stats');
