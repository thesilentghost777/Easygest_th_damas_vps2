...
use HistorisableActions;
...

    {
        ...
        // Historiser l'action
        $this->historiser('Vente de sacs par '.Auth()->user()->name.' pour l\'assignation '.$reception->assignment->id.' du sac '.$reception->assignment    ->bag_id.' de la quantité '.$validated['quantity_sold'].' vendus et '.$validated['quantity_unsold'].' invendus', 'bag_sales_create');
...

    {
        ...
        // Historiser l'action
        $this->historiser('Mise à jour de la vente de sacs par '.Auth()->user()->name.' pour l\'assignation '.$sale->reception->assignment->id.' du sac '.$sale->reception->assignment->bag_id.' de la quantité '.$validated['quantity_sold'].' vendus et '.$validated['quantity_unsold'].' invendus', 'bag_sales_update');
