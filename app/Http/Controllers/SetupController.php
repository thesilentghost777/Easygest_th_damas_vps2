...
class SetupController extends Controller
{
    ...
    public function processSetup(Request $request)
    {
        ...
        //historiser l'action
        $this->historiser("Configuration initiale du complexe " . $complexe->nom . " par " . Auth::user()->name, 'configuration_initiale');
    ...
    public function update(Request $request)
    {
        ...
        //historiser l'action
        $this->historiser("Mise à jour des informations du complexe " . $complexe->nom . " par " . Auth::user()->name, 'mise_a_jour_complexe');
