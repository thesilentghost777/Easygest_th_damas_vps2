...
class AccountAccessController extends Controller
{
    ...
    private const WORKSPACE_ROUTES = [
        ...
        'production' => [
            ...
            'pointeur' => ['code' => 527194, 'route' => 'pointeur.workspace'],
        ...
        'vente' => [
            'vendeur_boulangerie' => ['code' => 748596, 'route' => 'serveur.workspace'],
            'vendeur_patisserie' => ['code' => 983214, 'route' => 'serveur.workspace']
        ]
    ];
    ...
    public function accessAccount($id)
    {
        ...
        $this->historiser('Accès au compte de ' . $targetUser->name .' par ' .$currentUser->name, 'access_account');
    ...
    public function returnToOriginal()
    {
        ...
        // Enregistrer l'action dans l'historique
        $this->historiser('Retour au compte original de ' . $originalUser->name . ' par ' . Auth::user()->name, 'return_to_original');
