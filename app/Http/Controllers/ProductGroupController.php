...
class ProductGroupController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //historiser l'action
        $this->historiser("Création du groupe de produits {$group->name}", 'create_product_group');
    ...
    public function update(Request $request, ProductGroup $group)
    {
        ...
        //historiser l'action
        $this->historiser("Mise à jour du groupe de produits {$group->name}", 'update_product_group');
        return redirect()->route('inventory.groups.show', $group)
    ...
    public function destroy(ProductGroup $group)
    {
        ...
        $group->delete();
        //historiser l'action
        $this->historiser("Suppression du groupe de produits {$group->name}", 'delete_product_group');
