...
class ProduitController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->historiser("Ajout du produit {$validated['nom']} (Réf: {$validated['reference']})", 'create_produit');
    ...
    public function update(Request $request, Produit $produit)
    {
        ...
        //historiser l'action en specifiant les details important
        $this->historiser("Mise à jour du produit {$produit->nom} (Réf: {$produit->reference})", 'update_produit');
        return redirect()->route('produits.index')
    ...
    public function destroy(Produit $produit)
    {
        ...
        $produit->delete();
        //historiser l'action en specifiant les details important
        $this->historiser("Suppression du produit {$produit->nom} (Réf: {$produit->reference})", 'delete_produit');
        return redirect()->route('produits.index')
