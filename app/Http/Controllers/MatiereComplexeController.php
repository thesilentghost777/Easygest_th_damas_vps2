...
class MatiereComplexeController extends Controller
{
    ...
    public function index()
    {
        ...
        ->where('nom', 'not like', 'Taules%')
        ->where('nom', 'not like', 'produit avarier%')
        ->get();
    ...
    public function toggle($id)
    {
        ...
        // Historiser l'action
        $this->historiser("L'utilisateur " . auth()->user()->name . " a " . ($matiere->provientDuComplexe() ? "retiré" : "ajouté") . " la matière {$matiere->nom} au complexe", 'toggle_matiere_complexe');
    ...
    public function updatePrix(Request $request, $id)
    {
        ...
        // Historiser l'action
        $this->historiser("L'utilisateur " . auth()->user()->name . " a mis à jour le prix de la matière ID: {$id} dans le complexe", 'update_matiere_complexe_prix');
        return redirect()->route('matieres.complexe.index')
