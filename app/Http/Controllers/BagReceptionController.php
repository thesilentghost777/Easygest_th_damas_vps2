...
use HistorisableActions;
...

    {
        ...
        //historiser l'action
        $this->historiser('Réception de sacs par '.Auth()->user()->name.' pour l\'assignation '.$assignment->id.' du sac '.$assignment->bag_id.' de la quantité '.$validated['quantity_received'], 'bag_receptions_create');
...

    {
        ...
        //historiser l'action
        $this->historiser('Mise à jour de la réception de sacs par '.Auth()->user()->name.' pour l\'assignation '.$reception->assignment->id.' du sac '.$reception->assignment->bag_id.' de la quantité '.$validated['quantity_received'], 'bag_receptions_update');
        return redirect()->route('bag.receptions.create')
