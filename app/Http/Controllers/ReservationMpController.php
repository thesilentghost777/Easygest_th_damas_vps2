    ...
    public function validerReservation(Request $request, ReservationMp $reservation)
    {
        try {
            ...
            if ($assignationExistante) {
                ...
                $assignationExistante->quantite_assignee += $quantiteEnUniteClassique;
                $assignationExistante->quantite_restante += $quantiteEnUniteClassique;
                ...
                $assignation->quantite_assignee = $quantiteEnUniteClassique;
                $assignation->unite_assignee =  $matiere->unite_classique;
                $assignation->quantite_restante = $quantiteEnUniteClassique;
