...
class RecipeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $this->historiser("Recette créée: {$recipe->name}", 'create_recipe');
            DB::commit();
    ...
    public function update(Request $request, Recipe $recipe)
    {
        ...
        try {
            ...
            //historiser l'action en specifiant les details important
            $this->historiser("Recette mise à jour: {$recipe->name}", 'update_recipe');
            DB::commit();
    ...
    public function destroy(Recipe $recipe)
    {
        $recipe->delete();
        //historiser l'action en specifiant les details important
        $this->historiser("Recette supprimée: {$recipe->name}", 'delete_recipe');
